...
API_KEY= 'j5xs4BnZgg7j9lrKECdJF2E9kLg0rggvFqUQYQW5UN-V1s3TRDesHefCTIn_CeE0J5FiomR_6Fi9UkB9B1PmlcS62OpMlStagjxmBrpwWZEkOPEPbR4tyIaPRGDfXXYx'
...
def query_api(params):
    ...
    """
    response = search(API_KEY, params)
